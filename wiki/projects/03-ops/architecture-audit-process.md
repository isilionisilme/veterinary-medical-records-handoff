...
Use these checkpoints after architecture-relevant changes:

- After targeted fixes (e.g., complexity reduction, dependency cleanup): run quick check audit.
- After a significant implementation wave affecting multiple modules: run partial audit.
- After a major milestone or architectural change: run complete audit and establish a new baseline.
