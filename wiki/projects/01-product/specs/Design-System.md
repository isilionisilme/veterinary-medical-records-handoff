...
**Breadcrumbs:** [Home](Home) / [Projects](Sitemap) / veterinary-medical-records / 01-product
...
> [Brand Guidelines](brand-guidelines). This table reflects **actual implementation values** from
...
- Barkibu Orange (see [Brand Guidelines](brand-guidelines)) is used as accent/CTA only.
