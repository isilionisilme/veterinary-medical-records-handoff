...
Reading order, document responsibilities, and precedence rules are summarized in [Home](Home).
...
Run instructions live in the repository root [`README.md`](https://github.com/isilionisilme/veterinary-medical-records-handoff/blob/main/README.md).
