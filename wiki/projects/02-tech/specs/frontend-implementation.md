...
elsewhere in the project wiki. Reading order, document authority, and cross-document precedence are summarized in
[Home](Home). If anything here appears to conflict with other documentation, **STOP and ask**.
...
- **Lean design system contract** Follow
  [Design System](Design-System) for tokens, primitives,
...
- The project wiki contains the documentation structure and reading order (see [Home](Home)).
...
project wiki (see [Home](Home)) (do not invent fields or semantics here).
